declare module 'github-api' {
    ...
    class Repository {
       ...
       * @return {axios.AxiosPromise} - the promise for the http request
       */
      listCommits(options?: { sha: string, path: string, author: string, since: (Date | string), until: (Date | string) }, cb?: Requestable.callback): axios.AxiosPromise;
       ...
       * @return {axios.AxiosPromise} - the promise for the http request
       */
      writeFile(branch: string, path: string, content: string, message: string, options?: { author: Object, commiter: Object, encode: boolean }, cb?: Requestable.callback): axios.AxiosPromise;
